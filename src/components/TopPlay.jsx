...
const TopChartCard = ({ song, i, isPlaying, activeSong, handlePlayClick, handlePauseCLick }) => (
  <div className="w-full flex flex-row items-center hover:bg-[#4c426e] py-2 p-4 rounded-lg cursor-pointer mb-2">
    <h3 className="font-bold text-base text-white mr-3">{1 + i}.</h3>
    <div className="flex-1 flex flex-row items-center justify-between">
      ...
      <div className="flex-1 flex flex-col justify-center mx-3">
        ...
        <Link to={`/artists/${song?.artists[0].adamid}`}>
          <p className="text-base font text-gray-300 mt-1">{song?.subtitle}</p>
        </Link>
      </div>
    </div>
...
const TopPlay = () => {
  ...
  return (
    <div ref={divRef} className="xl:ml-6 ml-0 xl:mb-0 mb-6 flex-1 xl:max-w-[500] max-w-full flex flex-col">
